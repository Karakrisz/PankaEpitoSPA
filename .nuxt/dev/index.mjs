...
import * as cheerio from 'file:///Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/node_modules/cheerio/dist/esm/index.js';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/node_modules/devalue/index.js';
import destr from 'file:///Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/node_modules/destr/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL, hasProtocol, withHttps, withoutProtocol, withLeadingSlash, withoutTrailingSlash, withBase } from 'file:///Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/node_modules/@unhead/ssr/dist/index.mjs';
import { createHooks } from 'file:///Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/node_modules/unenv/runtime/fetch/index.mjs';
import { klona } from 'file:///Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/node_modules/scule/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/node_modules/radix3/dist/index.mjs';
import { getContext } from 'file:///Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/node_modules/unctx/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/node_modules/consola/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/node_modules/errx/dist/index.js';
import { isVNode, toValue, unref, version } from 'file:///Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/node_modules/vue/index.mjs';
import devalue from 'file:///Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/node_modules/@nuxt/devalue/dist/devalue.mjs';
import nodemailer from 'file:///Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/node_modules/nodemailer/lib/nodemailer.js';
import options from 'file:///Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/.nuxt/nuxt-mail/options.mjs';
import send$1 from 'file:///Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/.nuxt/nuxt-mail/send.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/node_modules/ipx/dist/index.mjs';
import { isAbsolute } from 'file:///Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/node_modules/pathe/dist/index.mjs';
import { hash } from 'file:///Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/node_modules/ohash/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/node_modules/@unhead/shared/dist/index.mjs';
...
const _sXuHTxT6Dy = (function(nitro) {
...
const _inlineRuntimeConfig = {
    ...
    "routeRules": {
      ...
      "/sitemap_index.xml": {
        "headers": {
          ...
          "X-Sitemap-Prerendered": "2025-06-23T12:47:46.728Z"
        }
      },
      "/pages-sitemap.xml": {
        "headers": {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/public"
      ]
    },
    "http": {
      "domains": []
...
const serverAssets = [{"baseName":"server","dir":"/Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _mTU8eJ9ihF = defineNitroPlugin(async (nitroApp) => {
...
const _ln7StO = defineEventHandler(async (e) => {
...
const _ku7okA = defineEventHandler(async (e) => {
  const siteConfig = useSiteConfig(e);
  const nitroOrigin = useNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _lQbJhl = defineEventHandler(async (e) => {
...
const _eqKQXf = defineEventHandler(async event => {
  try {
...
const _M1sVtx = lazyEventHandler(() => {
...
const _lazy_UJqeOE = () => Promise.resolve().then(function () { return kulsoTokosAluminiumRedon$1; });
const _lazy_5X4Tip = () => Promise.resolve().then(function () { return linear$1; });
const _lazy_EieKgx = () => Promise.resolve().then(function () { return m9000BejaratiAjtok$1; });
const _lazy_BaoTkR = () => Promise.resolve().then(function () { return m9000EmeloToloAjto$1; });
const _lazy_N2Gsyq = () => Promise.resolve().then(function () { return m9000ToloBukoAjtok$1; });
const _lazy_CxzGSR = () => Promise.resolve().then(function () { return m9000$1; });
const _lazy_ZOhSdb = () => Promise.resolve().then(function () { return mEcoBejaratiAjto$1; });
const _lazy_TMKvTI = () => Promise.resolve().then(function () { return mEco$1; });
const _lazy_V23ehl = () => Promise.resolve().then(function () { return mOcBejaratiAjto$1; });
const _lazy_JtALWQ = () => Promise.resolve().then(function () { return mOc$1; });
const _lazy_A0yw0Q = () => Promise.resolve().then(function () { return raepithetoTokosAluminiumRedony$1; });
const _lazy_QRiKEx = () => Promise.resolve().then(function () { return raepithetoTokosMuanyagRedony$1; });
const _lazy_xTHCnB = () => Promise.resolve().then(function () { return redexKulsoTokosMuanyagRedony$1; });
const _lazy_PlfQDI = () => Promise.resolve().then(function () { return sitemap$1; });
const _lazy_9HZ6uN = () => Promise.resolve().then(function () { return smoovioToloajto$1; });
const _lazy_1lgJ9Z = () => Promise.resolve().then(function () { return vakolhatoTokosAluminiumRedony$1; });
const _lazy_X5XygX = () => Promise.resolve().then(function () { return vakolhatoTokosMuanyagRedony$1; });
...
const _lazy_V7Pm2Z = () => Promise.resolve().then(function () { return zipScreen$1; });
const _lazy_JZoL2p = () => Promise.resolve().then(function () { return zsaluzia2$1; });
...
const handlers = [
  ...
  { route: '/api/kulso-tokos-aluminium-redon', handler: _lazy_UJqeOE, lazy: true, middleware: false, method: undefined },
  { route: '/api/linear', handler: _lazy_5X4Tip, lazy: true, middleware: false, method: undefined },
  { route: '/api/m-9000-bejarati-ajtok', handler: _lazy_EieKgx, lazy: true, middleware: false, method: undefined },
  { route: '/api/m-9000-emelo-tolo-ajto', handler: _lazy_BaoTkR, lazy: true, middleware: false, method: undefined },
  { route: '/api/m-9000-tolo-buko-ajtok', handler: _lazy_N2Gsyq, lazy: true, middleware: false, method: undefined },
  { route: '/api/m-9000', handler: _lazy_CxzGSR, lazy: true, middleware: false, method: undefined },
  { route: '/api/m-eco-bejarati-ajto', handler: _lazy_ZOhSdb, lazy: true, middleware: false, method: undefined },
  { route: '/api/m-eco', handler: _lazy_TMKvTI, lazy: true, middleware: false, method: undefined },
  { route: '/api/m-oc-bejarati-ajto', handler: _lazy_V23ehl, lazy: true, middleware: false, method: undefined },
  { route: '/api/m-oc', handler: _lazy_JtALWQ, lazy: true, middleware: false, method: undefined },
  { route: '/api/raepitheto-tokos-aluminium-redony', handler: _lazy_A0yw0Q, lazy: true, middleware: false, method: undefined },
  { route: '/api/raepitheto-tokos-muanyag-redony', handler: _lazy_QRiKEx, lazy: true, middleware: false, method: undefined },
  { route: '/api/redex-kulso-tokos-muanyag-redony', handler: _lazy_xTHCnB, lazy: true, middleware: false, method: undefined },
  { route: '/api/sitemap', handler: _lazy_PlfQDI, lazy: true, middleware: false, method: undefined },
  { route: '/api/smoovio-toloajto', handler: _lazy_9HZ6uN, lazy: true, middleware: false, method: undefined },
  { route: '/api/vakolhato-tokos-aluminium-redony', handler: _lazy_1lgJ9Z, lazy: true, middleware: false, method: undefined },
  { route: '/api/vakolhato-tokos-muanyag-redony', handler: _lazy_X5XygX, lazy: true, middleware: false, method: undefined },
  ...
  { route: '/api/zip-screen', handler: _lazy_V7Pm2Z, lazy: true, middleware: false, method: undefined },
  { route: '/api/zsaluzia-2', handler: _lazy_JZoL2p, lazy: true, middleware: false, method: undefined },
  ...
  { route: '/mail/send', handler: _eqKQXf, lazy: false, middleware: false, method: "post" },
  { route: '/_ipx/**', handler: _M1sVtx, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_GflkU8, lazy: true, middleware: false, method: undefined }
];
...
const sources$1 = [
    ...
    },
    {
        ...
        "urls": [
            ...
            {
                "loc": "/aluminium-muanyag-redonyok"
            },
            {
                "loc": "/arnyekolastechnika"
            },
            {
                "loc": "/bejarati-ajtok"
            },
            {
                "loc": "/belteri-ajto-beepites"
            },
            {
            ...
            {
                "loc": "/ingyenes-helyszini-felmeres"
            },
            {
                "loc": "/kapcsolat"
            },
            ...
            {
                "loc": "/m-9000-bejarati-ajtok"
            },
            {
                "loc": "/m-9000-emelo-tolo-ajto"
            },
            {
                "loc": "/m-9000-tolo-buko-ajtok"
            },
            {
                "loc": "/m-eco-ablakok-es-erkelyajtok"
            },
            {
                "loc": "/m-eco-bejarati-ajto"
            },
            {
                "loc": "/m-oc-ablakok-es-erkelyajtok"
            },
            {
                "loc": "/m-oc-bejarati-ajto"
            },
            {
                "loc": "/nyilaszaro-beepitese"
            },
            {
...
const fetchCss = defineEventHandler(async (event) => {
  try {
    ...
    if (!url) {
      return {
        statusCode: 400,
        error: "URL param\xE9ter k\xF6telez\u0151"
      };
    }
    const headers = {
    ...
    console.log("CSS let\xF6lt\xE9se:", url);
    const response = await fetch(url, { headers });
    if (!response.ok) {
      throw new Error(`HTTP hiba! St\xE1tusz: ${response.status}`);
    }
    ...
    console.error("Hiba a CSS let\xF6lt\xE9se sor\xE1n:", error);
    return {
      statusCode: 500,
      error: "Hiba t\xF6rt\xE9nt a CSS let\xF6lt\xE9se k\xF6zben",
      message: error.message
    };
  }
});

const fetchCss$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: fetchCss
});
...
const kulsoTokosAluminiumRedon = defineEventHandler(async (event) => {
  try {
    const url = "https://www.marshallablak.hu/termekek/kulso-tokos-aluminium-redony/";
    const headers = {
      "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.110 Safari/537.36",
      Accept: "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8",
      "Accept-Language": "hu,en-US;q=0.7,en;q=0.3"
...
const kulsoTokosAluminiumRedon$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: kulsoTokosAluminiumRedon
});
...
const m9000BejaratiAjtok = defineEventHandler(async (event) => {
  try {
    const url = "https://www.marshallablak.hu/termekek/m-9000-bejarati-ajtok/";
    const headers = {
      "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.110 Safari/537.36",
      Accept: "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8",
      "Accept-Language": "hu,en-US;q=0.7,en;q=0.3"
    ...
    const result = `
      ...
      <head>
        ...
        section.elementor-section.elementor-top-section.elementor-element.elementor-element-039cdb2.elementor-section-boxed.elementor-section-height-default.elementor-section-height-default {
          ...
          section.elementor-section.elementor-top-section.elementor-element.elementor-element-636fc247.elementor-section-boxed.elementor-section-height-default.elementor-section-height-default .elementor-container.elementor-column-gap-default {
            display: flex;
            margin: 4em 0 1em 0;
            padding: 0 7% 2em 7%;
          }
          ...
          section.elementor-section.elementor-top-section.elementor-element.elementor-element-123f55c0.elementor-section-boxed.elementor-section-height-default.elementor-section-height-default .elementor-container.elementor-column-gap-default {
          }
          img.attachment-full.size-full{
            width: 100%;
            height: 30em;
          ...
          .elementor-column.elementor-col-50.elementor-top-column.elementor-element.elementor-element-575940e2  {
            width: 50%;
                padding: 0 3em 2em 3em;
          }    
          #fenti-tulajdonsagok .elementor-widget-container {
          ...
          section.elementor-section.elementor-top-section.elementor-element.elementor-element-8aa29a3.elementor-section-boxed.elementor-section-height-default.elementor-section-height-default {
            background: #FBFBFF;
            padding: 3em 7% 5em 7%;
          }
          section.elementor-section.elementor-top-section.elementor-element.elementor-element-5411cb26.elementor-section-boxed.elementor-section-height-default.elementor-section-height-default {
            padding: 4em 7% 4em 7%;
            background: #f7f7f7;
          }
          section.elementor-section.elementor-top-section.elementor-element.elementor-element-46c78fa5.elementor-section-boxed.elementor-section-height-default.elementor-section-height-default {
            padding: 1em 7% 0 7%;
          }
          section.elementor-section.elementor-top-section.elementor-element.elementor-element-e5321b3.elementor-section-boxed.elementor-section-height-default.elementor-section-height-default {
            display: none;
          ...
          section.elementor-section.elementor-top-section.elementor-element.elementor-element-8aa29a3.elementor-section-boxed.elementor-section-height-default.elementor-section-height-default h2 {
            margin-bottom: 2em;
          }
         .elementor-element.elementor-element-7f604550.ob-harakiri-inherit.ob-has-background-overlay.elementor-widget.elementor-widget-heading h3 {
            margin-bottom: 2em;
...
const m9000BejaratiAjtok$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: m9000BejaratiAjtok
});

const m9000EmeloToloAjto = defineEventHandler(async (event) => {
  try {
    const url = "https://www.marshallablak.hu/termekek/m-9000-emelo-tolo-ajto/";
    const headers = {
      "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.110 Safari/537.36",
      Accept: "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8",
      "Accept-Language": "hu,en-US;q=0.7,en;q=0.3"
...
const m9000EmeloToloAjto$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: m9000EmeloToloAjto
});

const m9000ToloBukoAjtok = defineEventHandler(async (event) => {
  try {
...
const m9000ToloBukoAjtok$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: m9000ToloBukoAjtok
});
...
const mEcoBejaratiAjto = defineEventHandler(async (event) => {
  try {
    const url = "https://www.marshallablak.hu/termekek/m-eco-bejarati-ajto/";
    const headers = {
      "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.110 Safari/537.36",
      Accept: "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8",
      "Accept-Language": "hu,en-US;q=0.7,en;q=0.3"
...
const mEcoBejaratiAjto$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: mEcoBejaratiAjto
});
...
const mEco$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: mEco
});

const mOcBejaratiAjto = defineEventHandler(async (event) => {
  try {
    const url = "https://www.marshallablak.hu/termekek/m-oc-bejarati-ajto/";
    const headers = {
      "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.110 Safari/537.36",
      Accept: "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8",
      "Accept-Language": "hu,en-US;q=0.7,en;q=0.3"
...
const mOcBejaratiAjto$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: mOcBejaratiAjto
});

const mOc = defineEventHandler(async (event) => {
  try {
    const url = "https://www.marshallablak.hu/termekek/m-oc-ablakok-es-erkelyajtok/";
    const headers = {
      "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.110 Safari/537.36",
      Accept: "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8",
      "Accept-Language": "hu,en-US;q=0.7,en;q=0.3"
...
const mOc$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: mOc
});

const raepithetoTokosAluminiumRedony = defineEventHandler(async (event) => {
  try {
    const url = "https://www.marshallablak.hu/termekek/raepitheto-tokos-aluminium-redony/";
    const headers = {
      "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.110 Safari/537.36",
      Accept: "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8",
      "Accept-Language": "hu,en-US;q=0.7,en;q=0.3"
...
const raepithetoTokosAluminiumRedony$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: raepithetoTokosAluminiumRedony
});

const raepithetoTokosMuanyagRedony = defineEventHandler(async (event) => {
  try {
    const url = "https://www.marshallablak.hu/termekek/raepitheto-tokos-muanyag-redony/";
    const headers = {
      "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.110 Safari/537.36",
      Accept: "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8",
      "Accept-Language": "hu,en-US;q=0.7,en;q=0.3"
...
const raepithetoTokosMuanyagRedony$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: raepithetoTokosMuanyagRedony
});

const redexKulsoTokosMuanyagRedony = defineEventHandler(async (event) => {
  try {
    const url = "https://www.marshallablak.hu/termekek/redex-kulso-tokos-muanyag-redony/";
    const headers = {
      "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.110 Safari/537.36",
      Accept: "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8",
      "Accept-Language": "hu,en-US;q=0.7,en;q=0.3"
...
const redexKulsoTokosMuanyagRedony$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: redexKulsoTokosMuanyagRedony
});
...
const smoovioToloajto = defineEventHandler(async (event) => {
  try {
    const url = "https://www.marshallablak.hu/termekek/smoovio-toloajto/";
    const headers = {
      "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.110 Safari/537.36",
      Accept: "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8",
      "Accept-Language": "hu,en-US;q=0.7,en;q=0.3"
...
const smoovioToloajto$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: smoovioToloajto
});

const vakolhatoTokosAluminiumRedony = defineEventHandler(async (event) => {
  try {
    const url = "https://www.marshallablak.hu/termekek/vakolhato-tokos-aluminium-redony/";
    const headers = {
      "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.110 Safari/537.36",
      Accept: "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8",
      "Accept-Language": "hu,en-US;q=0.7,en;q=0.3"
...
const vakolhatoTokosAluminiumRedony$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: vakolhatoTokosAluminiumRedony
});

const vakolhatoTokosMuanyagRedony = defineEventHandler(async (event) => {
  try {
    const url = "https://www.marshallablak.hu/termekek/vakolhato-tokos-muanyag-redony/";
    const headers = {
      "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.110 Safari/537.36",
      Accept: "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8",
      "Accept-Language": "hu,en-US;q=0.7,en;q=0.3"
...
const vakolhatoTokosMuanyagRedony$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: vakolhatoTokosMuanyagRedony
});
...
const zipScreen = defineEventHandler(async (event) => {
  try {
    const url = "https://www.marshallablak.hu/termekek/zip-screen/";
    const headers = {
      "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.110 Safari/537.36",
      Accept: "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8",
      "Accept-Language": "hu,en-US;q=0.7,en;q=0.3"
    ...
    const result = `
      ...
      <head>
        ...
        section.elementor-section.elementor-top-section.elementor-element.elementor-element-7bbbb50e.elementor-section-boxed.elementor-section-height-default.elementor-section-height-default .elementor-container.elementor-column-gap-default  {
          }
          img.attachment-full.size-full{
            width: 100%;
            height: 30em;
        ...
        section.elementor-section.elementor-top-section.elementor-element.elementor-element-7bbbb50e.elementor-section-boxed.elementor-section-height-default.elementor-section-height-default .elementor-container.elementor-column-gap-default {
          ...
          .elementor-column.elementor-col-50.elementor-top-column.elementor-element.elementor-element-22be4bc3  {
            width: 50%;
                padding: 0 3em 2em 3em;
          }    
          #fenti-tulajdonsagok .elementor-widget-container {
...
const zipScreen$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: zipScreen
});

const zsaluzia2 = defineEventHandler(async (event) => {
  try {
    const url = "https://www.marshallablak.hu/termekek/zsaluzia-2/";
    const headers = {
      "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.110 Safari/537.36",
      Accept: "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8",
      "Accept-Language": "hu,en-US;q=0.7,en;q=0.3"
...
const zsaluzia2$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: zsaluzia2
});
...
const getClientManifest = () => import('file:///Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Applications/XAMPP/xamppfiles/htdocs/PankaEpitoSPA/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
