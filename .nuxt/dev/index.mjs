    ...
    "routeRules": {
      ...
      "/sitemap.xml": {
        "headers": {
          ...
          "X-Sitemap-Prerendered": "2025-04-14T08:23:56.071Z"
        }
      },
      "/_nuxt/builds/meta/**": {
        "headers": {
...
const _lazy_bJZrRo = () => Promise.resolve().then(function () { return scrape$1; });
...
const handlers = [
  ...
  { route: '/api/scrape', handler: _lazy_bJZrRo, lazy: true, middleware: false, method: undefined },
...
const scrape$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: scrape
});
