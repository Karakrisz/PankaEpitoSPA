<script setup>
useHead({
  title: 'M-ECO bejárati ajtók',
  meta: [
    {
      name: 'description',
      content: 'M-ECO bejárati ajtók részletes információi.',
    },
  ],
})
...
const { data, pending, error: fetchError } = await useFetch('/api/m-eco-bejarati-ajto')
