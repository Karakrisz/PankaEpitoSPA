<script setup>
useHead({
  title: 'Smoovio Slide tolóajtó',
  meta: [
    {
      name: 'description',
      content: 'Smoovio Slide tolóajtó részletes információi.',
    },
  ],
})
...
const { data, pending, error: fetchError } = await useFetch('/api/smoovio-toloajto')
