<script setup>
useHead({
  title: 'M-9000 bejárati ajtók ajtók',
  meta: [
    {
      name: 'description',
      content: 'M-9000 bejárati ajtók ajtók részletes információi.',
    },
  ],
})
...
const { data, pending, error: fetchError } = await useFetch('/api/m-9000-bejarati-ajtok')
