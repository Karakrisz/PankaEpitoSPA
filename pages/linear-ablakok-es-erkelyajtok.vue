<script setup>
useHead({
  title: 'Linear ablakok és erkélyajtók',
  meta: [
    {
      name: 'description',
      content: 'Linear ablakok és erkélyajtók részletes információi.',
    },
  ],
})
...
const { data, pending, error: fetchError } = await useFetch('/api/linear')
