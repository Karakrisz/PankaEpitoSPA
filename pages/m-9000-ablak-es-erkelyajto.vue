<script setup>
useHead({
  title: 'M-9000 ablakok és erkélyajtók',
  meta: [
    {
      name: 'description',
      content: 'M-9000 ablakok és erkélyajtók részletes információi.',
    },
  ],
})
...
const { data, pending, error: fetchError } = await useFetch('/api/m-9000')
