<script setup>
useHead({
  title: 'Vakolható tokos alumínium redőny',
  meta: [
    {
      name: 'description',
      content: 'Vakolható tokos alumínium redőny részletes információi.',
    },
  ],
})
...
const {
  ...
  pending,
  error: fetchError,
} = await useFetch('/api/vakolhato-tokos-aluminium-redony')
