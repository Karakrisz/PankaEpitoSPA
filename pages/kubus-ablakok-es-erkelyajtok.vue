<script setup>
useHead({
  title: 'KUBUS ablakok és erkélyajtók',
  meta: [
    {
      name: 'description',
      content: 'KUBUS ablakok és erkélyajtók részletes információi.',
    },
  ],
})
...
const { data, pending, error: fetchError } = await useFetch('/api/kubus')
